...
//disabled:data-[state=checked]:bg-primary/90 disabled:data-[state=checked]:text-primary-foreground disabled:data-[state=checked]:border-primary/30
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        'disabled:data-[state=checked]:bg-primary/50 disabled:data-[state=checked]:text-primary-foreground disabled:data-[state=checked]:border-primary/20',
        'disabled:dark:data-[state=checked]:bg-primary/50 disabled:dark:data-[state=checked]:text-primary-foreground disabled:dark:data-[state=checked]:border-primary/20',
        //"disabled:opacity-50",
        className,
      )}
      {...props}
