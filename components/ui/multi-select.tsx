            ...
            >
              {selectedValues.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className={cn(
                        ...
                        !disabled && 'cursor-pointer hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 ',
                      )}
                    >
                    ...
                    {!disabled && (
                      <div className="cursor-pointer aria-readonly:cursor-auto" aria-hidden="true" aria-readonly={disabled}>
                        <ChevronDown className="h-4 mx-2 pointer-events-none text-muted-foreground " aria-hidden="true" />
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  ...
                  {!disabled && (
                    <div className="cursor-pointer aria-readonly:cursor-auto" aria-hidden="true" aria-readonly={disabled}>
                      <ChevronDown aria-readonly={disabled} className="h-4 text-muted-foreground mx-2  pointer-events-none" aria-hidden="true" />
                    </div>
                  )}
                </div>
              )}
